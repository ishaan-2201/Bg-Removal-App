  ...
  return (
    <div className="mx-4 lg:mx-44 py-20 xl:py-40">
      ...
      <div className="flex flex-wrap items-start justify-center gap-4 mt-16 xl:mt-24">
        {/* First of the three divs starting */}
        <div className="flex items-start gap-4 bg-white p-7 pb-10 border drop-shadow-md rounded hover:scale-105 transition-all duration-500">
        ...
        {/* First of the three divs ending */}
        <div className="flex items-start gap-4 bg-white p-7 pb-10 border drop-shadow-md rounded hover:scale-105 transition-all duration-500">
